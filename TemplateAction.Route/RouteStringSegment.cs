...
{
    public class RouteStringSegment : IEquatable<RouteStringSegment>, IEquatable<string>
    {
        /// <summary>
        /// A <see cref="StringSegment"/> for <see cref="string.Empty"/>.
        /// </summary>
        public static readonly RouteStringSegment Empty = string.Empty;
        ...
        /// </param>
        public RouteStringSegment(string buffer)
        {
            Buffer = buffer;
            Offset = 0;
        ...
        public RouteStringSegment(string buffer, int offset, int length)
        {
            Buffer = buffer;
            Offset = offset;
            Length = length;
        ...
        /// </returns>
        public static int Compare(RouteStringSegment a, RouteStringSegment b, StringComparison comparisonType)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            RouteStringSegment tmp =obj as RouteStringSegment;
            if (tmp != null)
            {
                return Equals(tmp);
            }
        ...
        public bool Equals(RouteStringSegment other)
        {
        ...
        /// <returns><code>true</code> if the current object is equal to the other parameter; otherwise, <code>false</code>.</returns>
        public bool Equals(RouteStringSegment other, StringComparison comparisonType)
        {
        ...
        public static bool Equals(RouteStringSegment a, RouteStringSegment b, StringComparison comparisonType)
        {
        ...
        public static bool operator ==(RouteStringSegment left, RouteStringSegment right)
        {
        ...
        public static implicit operator RouteStringSegment(string value)
        {
            return new RouteStringSegment(value);
        }
        ...
        public RouteStringSegment Subsegment(int offset)
        {
        ...
        public RouteStringSegment Subsegment(int offset, int length)
        {
            return new RouteStringSegment(Buffer, Offset + offset, length);
        }
        ...
        public RouteStringSegment Trim()
        {
        ...
        /// </summary>
        /// <returns>The trimmed <see cref="StringSegment"/>.</returns>
        public RouteStringSegment TrimStart()
        {
            ...
            return new RouteStringSegment(Buffer, trimmedStart, Offset + Length - trimmedStart);
        }
        ...
        /// </summary>
        /// <returns>The trimmed <see cref="StringSegment"/>.</returns>
        public RouteStringSegment TrimEnd()
        {
            ...
            return new RouteStringSegment(Buffer, Offset, trimmedEnd - Offset + 1);
        }
        ...
        /// <returns></returns>
        public static bool IsNullOrEmpty(RouteStringSegment value)
        {
