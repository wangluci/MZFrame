...
{
    public static class RouteInlineParameterParser
    {
        public static RouteTemplatePart ParseRouteParameter(string routeParameter)
        {
            ...
            {
                return RouteTemplatePart.CreateParameter(
                    name: string.Empty,
                    isCatchAll: false,
                    isOptional: false,
                    defaultValue: null,
            ...
            return RouteTemplatePart.CreateParameter(parameterName,
                                                isCatchAll,
                                                isOptional,
                                                defaultValue,
        ...
        private static ConstraintParseResults ParseConstraints(
            ...
            int endIndex)
        {
            var inlineConstraints = new List<RouteInlineConstraint>();
                    ...
                    case ParseState.InsideParenthesis:
                        switch (currentChar)
                        {
                            case null:
                                ...
                                inlineConstraints.Add(new RouteInlineConstraint(constraintText));
                                break;
                            case ')':
        ...
        private struct ConstraintParseResults
        {
            ...
            public IEnumerable<RouteInlineConstraint> Constraints;
        }
    }
}
