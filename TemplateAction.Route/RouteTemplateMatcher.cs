...
namespace TemplateAction.Route
{
    public class RouteTemplateMatcher
    {
        ...
        public bool TryMatch(string path, IDictionary<string, object> values)
        {
            if (values == null)
            {
            ...
            var i = 0;
            var pathTokenizer = new RoutePathTokenizer(path);
        ...
        private bool MatchComplexSegment(
            RouteTemplateSegment routeSegment,
            ...
            int indexOfLastSegmentUsed)
        {
            ...
            RouteTemplatePart parameterNeedsValue = null; // Keeps track of a parameter segment that is pending a value
            RouteTemplatePart lastLiteral = null; // Keeps track of the left-most literal we've encountered
