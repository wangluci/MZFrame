...
namespace ResumeMLML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"E:\xxcode.txt";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.LinearSvm(new LinearSvmTrainer.Options() { Lambda = 0.0001796352f, PerformProjection = true, NoBias = false, NumberOfIterations = 16, InitialWeightsDiameter = 0.5238888f, Shuffle = true, LabelColumnName = @"col0", FeatureColumnName = "Features" }), labelColumnName: @"col0")
