...
namespace MyAccess.WordSegment.Setting
{
    ...
    public class PanGuSettings
    {
        ...
        private Match.MatchOptions _MatchOptions = new WordSegment.Match.MatchOptions();
        ...
        private Match.MatchParameter _Parameters = new WordSegment.Match.MatchParameter();
        ...
        {
            Match.MatchOptions options = new WordSegment.Match.MatchOptions();
        ...
        {
            Match.MatchParameter parameter = new WordSegment.Match.MatchParameter();
