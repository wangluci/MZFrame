...
namespace MyAccess.log4net.Util
{
	/// <summary>
	...
	/// </para>
	/// <para>
	/// This class functions similarly to the <see cref="MyAccesslog4net.Layout.PatternLayout"/>
	/// in that it accepts a pattern and renders it to a string. Unlike the 
	/// <see cref="MyAccesslog4net.Layout.PatternLayout"/> however the <c>PatternString</c>
	...
	/// </para>
	/// <para>
	/// See the <see cref="MyAccesslog4net.Layout.PatternLayout"/> for details on the 
