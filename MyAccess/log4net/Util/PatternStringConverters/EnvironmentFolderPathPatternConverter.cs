...
namespace MyAccess.log4net.Util.PatternStringConverters
{
    ...
    /// The value of the <see cref="MyAccesslog4net.Util.PatternConverter.Option"/> determines 
    /// the name of the variable to output. <see cref="MyAccesslog4net.Util.PatternConverter.Option"/>
    ...
    internal sealed class EnvironmentFolderPathPatternConverter : PatternConverter
    {
        ...
        /// using the <see cref="MyAccesslog4net.Util.PatternConverter.Option"/>
        /// property.
        /// </para>
        /// </remarks>
