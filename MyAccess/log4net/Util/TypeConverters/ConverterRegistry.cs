...
namespace MyAccess.log4net.Util.TypeConverters
{
	/// <summary>
	...
	public sealed class ConverterRegistry
	{
		...
		static ConverterRegistry()
		{
			...
			AddConverter(typeof(MyAccess.log4net.Layout.PatternLayout), typeof(PatternLayoutConverter));
			AddConverter(typeof(MyAccess.log4net.Util.PatternString), typeof(PatternStringConverter));
