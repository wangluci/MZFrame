...
namespace MyAccess.log4net.ObjectRenderer
{
	/// <summary>
			...
			else 
			{
				...
				else
				{
					...
					catch(Exception ex)
					{
						...
						MyAccess.log4net.Util.LogLog.Error(declaringType, "Exception while rendering object of type ["+obj.GetType().FullName+"]", ex);
