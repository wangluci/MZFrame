...
namespace MyAccess.log4net.Plugin
{
	...
	/// with a <see cref="MyAccesslog4net.Repository.ILoggerRepository"/>.
	/// The <see cref="PluginMap"/> held by the <see cref="MyAccesslog4net.Repository.ILoggerRepository.PluginMap"/>
