...
namespace MyAccess.log4net.Core
{
	...
	/// This mapping is held separately for each <see cref="MyAccesslog4net.Repository.ILoggerRepository"/>.
	...
	public sealed class LevelMap
	{
		...
		public void Add(string name, int value, string displayName)
		{
			...
			if (name.Length == 0)
			{
				throw MyAccess.log4net.Util.SystemInfo.CreateArgumentOutOfRangeException("name", name, "Parameter: name, Value: ["+name+"] out of range. Level name must not be empty");
			}
