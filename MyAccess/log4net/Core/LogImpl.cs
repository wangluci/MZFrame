...
namespace MyAccess.log4net.Core
{
	...
	public class LogImpl : LoggerWrapperImpl, ILog
	{
		...
		/// <see cref="MyAccesslog4net.ObjectRenderer.IObjectRenderer"/>. It then 
		...
		/// <summary>
		/// Event handler for the <see cref="MyAccesslog4net.Repository.ILoggerRepository.ConfigurationChanged"/> event
		/// </summary>
