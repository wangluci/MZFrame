...
namespace MyAccess.log4net.Core
{
...
#endif
	{
		...
		/// </para>
		/// </remarks>
		public LoggingEvent(Type callerStackBoundaryDeclaringType, Repository.ILoggerRepository repository, string loggerName, Level level, object message, Exception exception) 
		{
		...
		/// </para>
		/// </remarks>
		public LoggingEvent(Type callerStackBoundaryDeclaringType, Repository.ILoggerRepository repository, LoggingEventData data, FixFlags fixedData) 
		{
			m_callerStackBoundaryDeclaringType = callerStackBoundaryDeclaringType;
			m_repository = repository;
		...
		/// </para>
		/// </remarks>
		public LoggingEvent(Type callerStackBoundaryDeclaringType, Repository.ILoggerRepository repository, LoggingEventData data) : this(callerStackBoundaryDeclaringType, repository, data, FixFlags.All)
		{
		}
		...
		/// <see cref="MyAccesslog4net.Appender.IAppender.DoAppend"/> method call if this event 
