...
namespace MyAccess.log4net.Core
{
	...
	/// <see cref="MyAccesslog4net.Appender.IAppender.DoAppend"/> method.
	/// </para>
	/// <para>
	/// When objects that implement this interface are stored 
	/// in the context properties maps <see cref="MyAccesslog4net.GlobalContext"/>
	/// <see cref="MyAccesslog4net.GlobalContext.Properties"/> and <see cref="MyAccesslog4net.ThreadContext"/>
	/// <see cref="MyAccesslog4net.ThreadContext.Properties"/> are fixed 
