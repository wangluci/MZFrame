...
namespace MyAccess.log4net.Core
{
	...
	/// </para>
	/// <para>
	/// The levels that are recognized by log4net are set for each <see cref="MyAccesslog4net.Repository.ILoggerRepository"/>
	/// and each repository can have different levels defined. The levels are stored
	/// in the <see cref="MyAccesslog4net.Repository.ILoggerRepository.LevelMap"/> on the repository. Levels are
	/// looked up by name from the <see cref="MyAccesslog4net.Repository.ILoggerRepository.LevelMap"/>.
	/// </para>
	/// <para>
