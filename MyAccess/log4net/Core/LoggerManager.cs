...
namespace MyAccess.log4net.Core
{
	...
	/// </para>
	/// <para>
	/// This class is used by the wrapper managers (e.g. <see cref="MyAccesslog4net.LogManager"/>)
	...
	public sealed class LoggerManager
	{
		...
		static LoggerManager()
		{
			...
			{
				LogLog.Debug(declaringType, "注册AppDomain事件异常.AppDomain退出时loggermanager.shutdown()不会自动调用,必须手动调用.");
			}
			...
			{
				s_repositorySelector = new DefaultRepositorySelector(typeof(MyAccess.log4net.Repository.Hierarchy.Hierarchy));
			}
		}
		...
		/// <see cref="MyAccesslog4net.Repository.Hierarchy.Hierarchy"/> object.
		/// </para>
		/// <para>
