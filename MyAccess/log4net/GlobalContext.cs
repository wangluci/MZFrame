...
namespace MyAccess.log4net
{
	...
	/// be included in the output of log messages. The <see cref="MyAccesslog4net.Layout.PatternLayout"/>
	...
	public sealed class GlobalContext
	{
		...
		{
			Properties[MyAccess.log4net.Core.LoggingEvent.HostNameProperty] = SystemInfo.HostName;
		}
