...
namespace MyAccess.log4net.Config
{
	...
	/// specifies the type of the <see cref="MyAccesslog4net.Repository.ILoggerRepository"/> object 
	...
	public /*sealed*/ class RepositoryAttribute : Attribute
	{
		...
		/// The type must implement the <see cref="MyAccesslog4net.Repository.ILoggerRepository"/>
		/// interface.
		/// </para>
		/// <para>
