...
namespace MyAccess.log4net.Filter
{
	/// <summary>
	...
	/// event filtering. Note that <see cref="MyAccesslog4net.Repository.Hierarchy.Logger"/> and 
	/// <see cref="MyAccesslog4net.Appender.AppenderSkeleton"/>, the parent class of all standard
