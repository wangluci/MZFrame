...
namespace MyAccess.log4net.Appender
{
	/// <summary>
	...
	public class TextWriterAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="MyAccesslog4net.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </summary>
		/// <value>
		/// The <see cref="MyAccesslog4net.Util.QuietTextWriter"/> where logging events are written.
		/// </value>
		/// <remarks>
		/// <para>
		/// This is the <see cref="MyAccesslog4net.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </para>
		/// </remarks>
