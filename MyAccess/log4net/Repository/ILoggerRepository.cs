...
using MyAccess.log4net;
using MyAccess.log4net.ObjectRenderer;
using MyAccess.log4net.Core;
using MyAccess.log4net.Plugin;
using MyAccess.log4net.Repository.Hierarchy;
using MyAccess.log4net.Util;

namespace MyAccess.log4net.Repository
{
	...
	public interface ILoggerRepository
	{
		...
		/// </para>
		/// </remarks>
		MyAccess.log4net.Appender.IAppender[] GetAppenders();
	}
}
