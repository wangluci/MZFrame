...
namespace MyAccess.log4net.Repository.Hierarchy
{
	#region 日志创建事件
    ...
    public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IXmlRepositoryConfigurator
	{
		...
		/// <remarks>
		/// <para>
		/// Returns all the <see cref="MyAccesslog4net.Appender.IAppender"/> instances that are currently configured.
