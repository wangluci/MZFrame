...
using MyAccess.log4net.Core;
using MyAccess.log4net.Layout.Pattern;
using MyAccess.log4net.Util;
using MyAccess.log4net.Util.PatternStringConverters;
using AppDomainPatternConverter=MyAccess.log4net.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter=MyAccess.log4net.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter=MyAccess.log4net.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter=MyAccess.log4net.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter=MyAccess.log4net.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter=MyAccess.log4net.Layout.Pattern.UtcDatePatternConverter;

namespace MyAccess.log4net.Layout
{
	/// <summary>
	...
	/// 			assumed (<see cref="MyAccesslog4net.DateFormatter.Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			<see cref="MyAccesslog4net.DateFormatter.AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="MyAccesslog4net.DateFormatter.DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="MyAccesslog4net.DateFormatter.Iso8601DateFormatter"/>. For example, 
